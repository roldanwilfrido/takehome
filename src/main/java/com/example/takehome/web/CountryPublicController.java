...
@Tag(name = "Countries (Public)", description = "Public endpoints for filtering countries")
@Validated
@AllArgsConstructor
@RestController
@RequestMapping("/public/countries/v1")
public class CountryPublicController extends CountryAbstract {

    private final RateLimitPublicService rateLimitService;
